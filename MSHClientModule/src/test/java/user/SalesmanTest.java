...
public class SalesmanTest {
    ...
    public void testAddSalesman() throws Exception {
        ResultMessage rm = salesman.addSalesman(new SalesmanVO("100789", "老王儿"));
        assertEquals(ResultMessage.SUCCESS,rm);
        rm = salesman.addSalesman(new SalesmanVO("100001","老王二"));
    ...
    public void testUpdateSalesman() throws Exception {
        ResultMessage rm = salesman.updateSalesman(new SalesmanVO("100001","小王"));
        assertEquals(ResultMessage.SUCCESS,rm);
        rm = salesman.updateSalesman(new SalesmanVO("100002","老王"));
        assertEquals(ResultMessage.FAILED,rm);
    }

    @Test
    public void testDeleteSalesman() throws Exception {
        ResultMessage rm = salesman.deleteSalesman("100001");
        assertEquals(ResultMessage.SUCCESS,rm);
        rm = salesman.deleteSalesman("100002");
        assertEquals(ResultMessage.FAILED,rm);
    }
