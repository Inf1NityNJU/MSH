...
//        promotionDataService.addPromotion(new PromotionPO("201611210102", PromotionType.Web_ClientGrade,0.80,"2016-11-01","2016-11-30","12","34",0, Place.TangShan,0));
    ...
    public void deletePromotion() throws Exception{
        promotionDataService.addPromotion(new PromotionPO("201611210103", PromotionType.Web_ClientGrade,0.80,"2016-11-01","2016-11-30","12","34",0, Place.TangShan,0));
    ...
    public void updatePromotion() throws Exception {
        ResultMessage resultMessage = promotionDataService.updatePromotion(new PromotionPO("201611210101", PromotionType.Web_ClientGrade,0.90,"2016-11-01","2016-11-30","12","34",0, Place.TangShan,0));
        assertEquals(ResultMessage.SUCCESS, resultMessage);
    }
...
//        PromotionPO promotionPO1 = new PromotionPO("201611210105", PromotionType.Web_ClientGrade,0.90,"2016-11-01","2016-11-30","12","34",0, Place.TangShan,0);
        assertEquals(new PromotionPO("201611210102", PromotionType.Web_ClientGrade,0.80,"2016-11-01","2016-11-30","12","34",0, Place.TangShan,0),promotionPO);
    }
    ...
    public void searchPromotionsByType() throws Exception {
        ...
        promotionPOsExpected.add(new PromotionPO("201611210101", PromotionType.Web_ClientGrade,0.90,"2016-11-01","2016-11-30","12","34",0, Place.TangShan,0));
        promotionPOsExpected.add(new PromotionPO("201611210102", PromotionType.Web_ClientGrade,0.80,"2016-11-01","2016-11-30","12","34",0, Place.TangShan,0));
        assertEquals(promotionPOsExpected, promotionPOs);
    }

    @Test
    public void searchHotelPromotions() throws Exception{
        promotionDataService.addPromotion(new PromotionPO("201611240101", PromotionType.Hotel_RoomQuantity, 0.80, "2016-11-01", "2016-11-30", "", "00000000", 2, Place.Unnecessary, 0));
        ArrayList<PromotionPO> promotionPOs = promotionDataService.searchHotelPromotions("00000000");
        ArrayList<PromotionPO> promotionPOsExpected = new ArrayList<PromotionPO>();
        promotionPOsExpected.add(new PromotionPO("201611240101", PromotionType.Hotel_RoomQuantity, 0.80, "2016-11-01", "2016-11-30", "", "00000000", 2, Place.Unnecessary, 0));
        assertEquals(promotionPOsExpected, promotionPOs);
    }
