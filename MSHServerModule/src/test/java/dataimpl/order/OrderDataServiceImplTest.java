...
public class OrderDataServiceImplTest {
    ...
    public void addOrder() {
        ResultMessage resultMessage = orderDataService.addOrder(new OrderPO("20161012010112340000", "01011234", "000000001",
                ...
                null, 1, PromotionType.Hotel_Birthday, 1, 300, 280));
    ...
    public void updateOrder() {
        ResultMessage resultMessage = orderDataService.updateOrder(new OrderPO("20161012010112340000", "01011234", "000000001",
                ...
                null, 1, PromotionType.Hotel_Birthday, 1, 300, 260));
        assertEquals(ResultMessage.SUCCESS, resultMessage);
    }
    ...
    public void searchOrderByClientID() {
        ArrayList<OrderPO> orders = orderDataService.searchOrderByClientID("000000001");
        assertEquals(1, orders.size());
    }

    @Test
    public void searchOrderByHotelID() {
        ArrayList<OrderPO> orders = orderDataService.searchOrderByHotelID("01011234");
        assertEquals(1, orders.size());
    }
